...
- (instancetype)initWithSender:(UIViewController*)sender{
    ...
    CGRect frame = CGRectMake([UIScreen mainScreen].bounds.size.width, 0, SLIP_WIDTH, bounds.size.height);
    self = [super initWithFrame:frame];
    if (self) {
...
-(void)buildViews:(UIViewController*)sender{
    ...
    _blurImageView = [[UIImageView alloc] initWithFrame:CGRectMake(-[UIScreen mainScreen].bounds.size.width, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)];
...
-(void)show:(BOOL)show{
    ...
    CGFloat x = show?[UIScreen mainScreen].bounds.size.width-SLIP_WIDTH:[UIScreen mainScreen].bounds.size.width;
